...
with tab2: # 감정분석 통계
    ...
    with t2_col1_1:
        ...
        Emotion_Stat_Dataset_Search_Result_1 = Emotion_Stat_Dataset.loc[Emotion_Stat_Dataset['User'] 
                                    == tab2_selectbox & Emotion_Stat_Dataset['Datetime'] >= t1_min_datetime.dt.date & Emotion_Stat_Dataset['Datetime'] <= tab2_targetdate.dt.date]
