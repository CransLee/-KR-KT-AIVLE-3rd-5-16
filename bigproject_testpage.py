...
with tab2: # 감정분석 통계
    ...
    with t2_col3_2:
        ...
        Emotion_Stat_Dataset_Search_Result_2.loc['Datetime'] = Emotion_Stat_Dataset_Search_Result_2['Datetime'].dt.strfttime('%y-%m-%d')
        st.text(Emotion_Stat_Dataset_Search_Result_2.loc[0, 'Datetime'])
        st.text(type(Emotion_Stat_Dataset_Search_Result_2.loc[0, 'Datetime']))
